...
namespace HumanResourcesAPI.Services {
    ...
    public interface IEmployeePayHistoryBuilder {
        ...
        IQueryable<EmployeePayHistoryModel> GetEmployeePayHistories();
        ...
        IQueryable<EmployeePayHistoryModel> GetEmployeePayHistory_ByBusinessEntityID(int businessEntityID);
