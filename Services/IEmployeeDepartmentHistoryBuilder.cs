...
namespace HumanResourcesAPI.Services {
    ...
    public interface IEmployeeDepartmentHistoryBuilder {
        ...
        IQueryable<EmployeeDepartmentHistoryModel> GetEmployeeDepartmentHistories();
        ...
        IQueryable<EmployeeDepartmentHistoryModel> GetEmployeeDepartmentHistory_ByBusinessEntityID(int businessEntityID);
        
        IQueryable<EmployeeDepartmentHistoryModel> GetEmployeeDepartmentHistory_ByDepartmentID(short departmentID);
        
        IQueryable<EmployeeDepartmentHistoryModel> GetEmployeeDepartmentHistory_ByShiftID(byte shiftID);
